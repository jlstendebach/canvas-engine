    ...
    drawLabels(context) {
        ...
        for (let i = 0; i < this.slices.length; ++i) {
            ...
            if (slice.eAngle - slice.sAngle > Math.PI * 2 / 36) {
                ...
                context.fillText(text, Math.cos((slice.sAngle + slice.eAngle) / 2) * (radius - 30), Math.sin((slice.sAngle + slice.eAngle) / 2) * (radius - 30));
            }
        }
    }
...
//# sourceMappingURL=PieChartView.js.map