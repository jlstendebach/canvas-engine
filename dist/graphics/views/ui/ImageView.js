...
export class ImageView extends View {
    ...
    setImage(image, resetSourceRect = true) {
        ...
        if (resetSourceRect) {
            ...
            this.setSourceSizeWH(image?.naturalWidth ?? 0, image?.naturalHeight ?? 0);
        }
        return this;
    }
    // MARK: - Size
    ...
    onDraw(context) {
        ...
        context.drawImage(this.#image, this.#sourceX, this.#sourceY, this.#sourceWidth, this.#sourceHeight, 0, // destination x
        0, // destination y
