...
export class LabelView extends View {
    ...
    containsPoint(point) {
        ...
        return (point.x >= labelX
            && point.x < labelX + this.getWidth()
            && point.y >= labelY
    ...
    measure(context) {
        ...
        /* SHRINK_X / GROW_X */
        /*********************/
        if ((this.isShrinkingX() && width !== 0 && width < this.getWidth())
        ...
        if ((height > this.getHeight() && this.isGrowingY())
    ...
    setGrowX(g) {
        if (g) {
            ...
            this.removeOverflowFlags(LabelViewOptions.GROW_X);
        }
    }
    isGrowingX() {
    ...
    setGrowY(g) {
        if (g) {
            ...
            this.removeOverflowFlags(LabelViewOptions.GROW_Y);
        }
    }
    isGrowingY() {
    ...
    setShrinkX(s) {
        if (s) {
            ...
            this.removeOverflowFlags(LabelViewOptions.SHRINK_X);
        }
    }
    isShrinkingX() {
    ...
    setShrinkY(s) {
        if (s) {
            ...
            this.removeOverflowFlags(LabelViewOptions.SHRINK_Y);
        }
    }
    isShrinkingY() {
    ...
    setWordWrap(w) {
        if (w) {
            ...
            this.removeOverflowFlags(LabelViewOptions.WORD_WRAP);
        }
    }
    isWordWrapping() {
    ...
    setClip(c) {
        if (c) {
            ...
            this.removeOverflowFlags(LabelViewOptions.CLIP);
        }
    }
    isClipping() {
    ...
    isValidOverflowFlag(flag) {
        return (flag >= LabelViewOptions.OVERFLOW_FLAG_MIN
    ...
    updateFont() {
        this.fontCached = "";
        if (this.isBold()) {
            this.fontCached = "bold ";
        }
        if (this.isItalic()) {
            this.fontCached += "italic ";
        }
    ...
    onDraw(context) {
        ...
        if (this.isClipping()) {
            context.beginPath();
            context.rect(0, 0, this.getWidth(), this.getHeight() + this.getFontSize() * 0.1);
