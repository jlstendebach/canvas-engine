...
export class Color {
    ...
    static fromHex(hexString) {
        ...
        return new Color(parseInt(cleanHex.substring(0, 2), 16), parseInt(cleanHex.substring(2, 4), 16), parseInt(cleanHex.substring(4, 6), 16), (cleanHex.length === 8) ? parseInt(cleanHex.substring(6, 8), 16) / 255 : 1.0);
    }
    /**
    ...
    static fromRgba(rgbaString) {
        ...
        return new Color(parseInt(match[1]), parseInt(match[2]), parseInt(match[3]), match[4] ? parseFloat(match[4]) : 1.0);
    }
    /**
    ...
    static lerp(colorA, colorB, t) {
        const u = 1 - t;
        return new Color(colorA.r * u + colorB.r * t, colorA.g * u + colorB.g * t, colorA.b * u + colorB.b * t, colorA.a * u + colorB.a * t);
    }
    // MARK: - Conversions
    /**
