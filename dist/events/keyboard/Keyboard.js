...
export class Keyboard {
    ...
    static onKeyDown(event) {
        ...
        if (Keyboard.isKeyDown(event.code)) {
            ...
            /* REPEAT */
            /**********/
            Keyboard.#eventEmitter.emit(KeyboardEvent.REPEAT, new KeyboardEvent(KeyboardEvent.REPEAT, event.key, event.code));
        }
        else {
            ...
            /* DOWN */
            /********/
            Keyboard.#eventEmitter.emit(KeyboardEvent.DOWN, new KeyboardEvent(KeyboardEvent.DOWN, event.key, event.code));
        }
    }
    static onKeyUp(event) {
        ...
        /* UP */
        /******/
        Keyboard.#eventEmitter.emit(KeyboardEvent.UP, new KeyboardEvent(KeyboardEvent.UP, event.key, event.code));
    }
